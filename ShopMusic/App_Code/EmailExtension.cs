...
namespace shop
{
    public class EmailExtension
    {
        ...
        {
            string SendFrom = "vongocthien0510@gmail.com";
            string password = "thien0510";
            ...
            {
                SmtpClient client = new SmtpClient("vongocthien0510@gmail.com", portGmail);
                client.EnableSsl = true;
                MailAddress from = new MailAddress(SendFrom, "shop music");
                MailAddress to = new MailAddress(SendTo, "shop music");
