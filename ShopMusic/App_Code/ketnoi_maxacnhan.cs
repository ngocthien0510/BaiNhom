...
{    
    ...
    private void layknoi()
    {
        ...
        con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\Kiểm Thử\btnhomhuongdan\ShopMusic\ShopMusic\App_Data\Maxacnhan.mdf;Integrated Security=True");
        con.Open();//mở kết nối
    }
