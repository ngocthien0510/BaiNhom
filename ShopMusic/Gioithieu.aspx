...
<body onselectstart="return false" oncontextmenu="return false">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
	        <div class="container-fluid">
			    <a class="navbar-branch" href="Default.aspx?">
				    <img src="images/music.jpg" height="60"/>
			    </a>
    ...
    <div class="modau">
    <h1 style="text-align:center;">Giới thiệu về SHOP MIUSIC</h1>
        </div>
    <p>Shop Music là nơi chuyên bán những dụng cụ âm nhạc được thiết kế chủ yếu để phục vụ cho cá nhân hoặc các hoạt động khác liên quan đến âm nhạc, 
                         chúng tôi có tất cả các loại dụng cụ âm nhạc. Các sản phẩm của chúng tôi làm từ  các chất liệu gỗ cao câp hoặc các chất liệu tổng hợp.
                            Các bộ phận trên dụng cụ âm nhạc được làm thủ công với những đôi tay của thợ lành nghề. Đến với chúng tôi bạn có sản phẩm chất lượng</p>
   <%-- <div style="margin-left:10%; margin-right:10%; line-height:1.5; text-indent:30px;">
    ...
    <div style="margin-left:10%; margin-right:10%; line-height:1.5; text-indent:30px;">
        Các website thuộc hệ thống SHOP MUSIC:<br><br>
    </div>
   <%-- <center><a href="Default.aspx"><img src="hinhanh/logo.png" width="100px"></a></center>--%>
    <center><a href="Default.aspx"><img src="hinhanh/logo.jpg" width="100px"/></a></center>
    
    <!--Footer-->
    <div class="div" id="footer">
        <center>
            &#169 2021 Copyright by SHOP MUSIC
        </center>
    </div>
