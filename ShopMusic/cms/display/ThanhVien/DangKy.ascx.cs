...
using System.Web.UI.WebControls;
    ...
    public partial class cms_display_ThanhVien_DangKy : System.Web.UI.UserControl
    {
        ...
        SqlConnection conn = new SqlConnection(@"Data Source=DELL5568\SQLEXPRESS;Initial Catalog=BANHANG1;Integrated Security=True");
        static string code;
        ...
        protected void lbtDangKy_Click(object sender, EventArgs e)
        {
            ...
            //{
            //    ScriptManager.RegisterStartupScript(this, this.GetType(), "", "alert('Email đã được đăng ký.Vui lòng nhập Email khác.');", true);
            //}
            //else
            //{
            //    string ngayTao = DateTime.Now.ToString("MM/dd/yyyy HH:mm:ss");

            //    shop.KhachHang.Khachhang_Insert(tbHoTen.Text, tbDiaChi.Text, tbSoDienThoai.Text, tbEmail.Text, tbMatKhau.Text, tbNhapLaiMatKhau.Text);
            //    ScriptManager.RegisterStartupScript(this, this.GetType(), "", "alert('đăng ký thành công.');location.href='Default.aspx?modul=ThanhVien&modulphu=DangNhap'", true);
    ...
    private void sendcode()
    {
        ...
        string fromaddr = "vongocthien0510@gmail.com";
        string toaddr = tbEmail.Text;//TO ADDRESS HERE

        string password = "dbirbzuaolhfidad";
