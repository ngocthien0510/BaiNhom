...
CREATE DATABASE [BANHANG1]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'BANHANG1', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\BANHANG1.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'BANHANG1_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\BANHANG1_log.ldf' , SIZE = 3456KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
ALTER DATABASE [BANHANG1] SET COMPATIBILITY_LEVEL = 100
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [BANHANG1].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [BANHANG1] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [BANHANG1] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [BANHANG1] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [BANHANG1] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [BANHANG1] SET ARITHABORT OFF 
GO
ALTER DATABASE [BANHANG1] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [BANHANG1] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [BANHANG1] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [BANHANG1] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [BANHANG1] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [BANHANG1] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [BANHANG1] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [BANHANG1] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [BANHANG1] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [BANHANG1] SET  DISABLE_BROKER 
GO
ALTER DATABASE [BANHANG1] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [BANHANG1] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [BANHANG1] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [BANHANG1] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [BANHANG1] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [BANHANG1] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [BANHANG1] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [BANHANG1] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [BANHANG1] SET  MULTI_USER 
GO
ALTER DATABASE [BANHANG1] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [BANHANG1] SET CHAINING OFF 
GO
ALTER DATABASE [BANHANG1] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [BANHANG1] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
ALTER DATABASE [BANHANG1] SET DELAYED_DURABILITY = DISABLED 
GO
EXEC sys.sp_vardecimal_storage_format N'BANHANG1', N'ON'
GO
ALTER DATABASE [BANHANG1] SET QUERY_STORE = OFF
GO
USE [BANHANG1]
GO
...
INSERT [dbo].[DanhMuc] ([MaDM], [TenDM], [ThuTu], [MaDMCha]) VALUES (1, N'Guitar', 1, 0)
INSERT [dbo].[DanhMuc] ([MaDM], [TenDM],  [ThuTu], [MaDMCha]) VALUES (2, N'Piano', 2, 0)
INSERT [dbo].[DanhMuc] ([MaDM], [TenDM],  [ThuTu], [MaDMCha]) VALUES (3, N'Trống', 3, 0)
INSERT [dbo].[DanhMuc] ([MaDM], [TenDM],  [ThuTu], [MaDMCha]) VALUES (4, N'Kèn', 4, 0)
INSERT [dbo].[DanhMuc] ([MaDM], [TenDM],  [ThuTu], [MaDMCha]) VALUES (5, N'Sáo', 5, 0)
INSERT [dbo].[DanhMuc] ([MaDM], [TenDM],  [ThuTu], [MaDMCha]) VALUES (6, N'Violin', 6, 0)
SET IDENTITY_INSERT [dbo].[DanhMuc] OFF
SET IDENTITY_INSERT [dbo].[Mau] ON 

INSERT [dbo].[Mau] ([MauID], [TenMau]) VALUES (1, N'Điện')
INSERT [dbo].[Mau] ([MauID], [TenMau]) VALUES (2, N'Cổ điển')
...
--INSERT [dbo].[DonDatHang] ([MaDonDatHang], [NgayTao], [ThanhTienDH], [TinhTrangDonHang],[PhuongThucThanhToan], [MaKH], [TenKH], [sdtKH], [EmailKH]) VALUES (1, CAST(N'2021-11-31T06:01:13.000' AS DateTime), 500000, N'Đang chờ duyệt', N'Thanh toán sau khi nhận hàng', 3, N'Tran a', N'987994431', N'vana@gmail.com')
--INSERT [dbo].[DonDatHang] ([MaDonDatHang], [NgayTao], [ThanhTienDH], [TinhTrangDonHang], [PhuongThucThanhToan],[MaKH], [TenKH], [sdtKH], [EmailKH]) VALUES (2, CAST(N'2021-11-31T11:46:37.000' AS DateTime), 500000, N'Đang chờ duyệt', N'Thanh toán sau khi nhận hàng', 3, N'thien', N'987994431', N'ngocthien@gmail.com')
...
INSERT [dbo].[SanPham](
	...
	[GiaSP] ,
	[MaDM] ,
	[NhomID]) VALUES (2,N'Guitar2',1,2,N'g2.jpg',N'10',N'500000',1,1)
...
INSERT [dbo].[SanPham](
	...
	[GiaSP] ,
	[MaDM] ,
	[NhomID]) VALUES (3,N'Guitar3',2,1,N'gd2.jpg',N'1',N'500000',1,1)
	INSERT [dbo].[SanPham](
	[MaSP],
	[TenSP] ,
	[MauID] ,
	...
	[GiaSP] ,
	[MaDM] ,
	[NhomID]) VALUES (4,N'Guitar5',1,1,N'gd3.jpg',N'1',N'400000',1,1)
	INSERT [dbo].[SanPham](
	[MaSP],
	[TenSP] ,
	[MauID] ,
	...
	[GiaSP] ,
	[MaDM] ,
	[NhomID]) VALUES (5,N'Piano1',1,2,N'p1.jpg',N'10',N'350000',2,1)
	INSERT [dbo].[SanPham](
	[MaSP],
	[TenSP] ,
	[MauID] ,
	...
	[GiaSP] ,
	[MaDM] ,
	[NhomID]) VALUES (6,N'Piano2',1,2,N'p2.jpg',N'10',N'350000',2,1)
	INSERT [dbo].[SanPham](
	[MaSP],
	[TenSP] ,
	[MauID] ,
	...
	[GiaSP] ,
	[MaDM] ,
	[NhomID]) VALUES (7,N'Piano3',1,1,N'pd1.jpg',N'10',N'350000',2,1)
	INSERT [dbo].[SanPham](
	[MaSP],
	[TenSP] ,
	[MauID] ,
	...
	[GiaSP] ,
	[MaDM] ,
	[NhomID]) VALUES (8,N'Piano4',1,1,N'pd2.jpg',N'10',N'350000',2,1)
	INSERT [dbo].[SanPham](
	[MaSP],
	[TenSP] ,
	[MauID] ,
	...
	[GiaSP] ,
	[MaDM] ,
	[NhomID]) VALUES (9,N'Trống8',1,1,N'td1.jpg',N'1',N'250000',3,1)
	INSERT [dbo].[SanPham](
	[MaSP],
	[TenSP] ,
	[MauID] ,
	...
	[GiaSP] ,
	[MaDM] ,
	[NhomID]) VALUES (10,N'Trống8',1,2,N't2.jpg',N'1',N'250000',3,1)
	INSERT [dbo].[SanPham](
	[MaSP],
	[TenSP] ,
	[MauID] ,
	...
	[GiaSP] ,
	[MaDM] ,
	[NhomID]) VALUES (11,N'Kèn1',1,2,N'k1.jpg',N'1',N'250000',4,1)
	INSERT [dbo].[SanPham](
	[MaSP],
	[TenSP] ,
	[MauID] ,
	...
	[GiaSP] ,
	[MaDM] ,
	[NhomID]) VALUES (12,N'Kèn1',1,2,N'k4.jpg',N'1',N'250000',4,1)
	INSERT [dbo].[SanPham](
	[MaSP],
	[TenSP] ,
	[MauID] ,
	...
	[GiaSP] ,
	[MaDM] ,
	[NhomID]) VALUES (13,N'Sáo2',1,2,N's2.jpg',N'1',N'250000',5,1)
...
INSERT [dbo].[Size] ([SizeID], [TenSize]) VALUES (1, N'nhỏ')
INSERT [dbo].[Size] ([SizeID], [TenSize]) VALUES (2, N'lớn')
...
USE [master]
GO
ALTER DATABASE [BANHANG1] SET  READ_WRITE 
GO